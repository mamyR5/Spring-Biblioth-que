            ...
            <div class="card">
                ...
                <div class="description">
                    ...
                    <% if(exemplaire.getStatus().equals("Disponible")) {%>
                       <div class="Statut"><a href="<%=request.getContextPath() %>/bibliothecaire/pret?idLivre=<%=exemplaire.getLivre().getIdlivre()%>&&idExemplaire=<%=exemplaire.getIdExemplaire()%>"><%= exemplaire.getStatus() %></a></div>
                    <% } else {%>
